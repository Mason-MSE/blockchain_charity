App = {
  ...
  loadContract: async () => {
    ...
    const networkId = Object.keys(charity.networks)[0]
    const deployedAddress = charity.networks[networkId].address
    App.charity = await App.contracts.charity.at(deployedAddress)
  },
